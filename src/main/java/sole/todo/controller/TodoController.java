...
public class TodoController {
    ...
    @PostMapping
    public ResponseEntity<String> postTodo(@Valid @RequestBody TodoDto todoDto) {
        Todo todo = todoService.createTodo(todoMapper.todoDtoToTodo(todoDto));

        return new ResponseEntity<>("To-do Application !",
                HttpStatus.CREATED);
...
//        if(todoDto.getCompleted() == null)
    ...
    public ResponseEntity<String> deleteTodo(@PathVariable("todo-id") @Positive long todoId) {
